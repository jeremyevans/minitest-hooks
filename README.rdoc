...
To define +before_all+ and +after_all+ hooks, just define the methods, don't use
<tt>before(:all)</tt> or <tt>after(:all)</tt>, and be sure to call super.
...
+around+ and +around_all+ are defined the same way they are defined in specs.
